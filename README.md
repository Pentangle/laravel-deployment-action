  ...
  build:
    ...
    steps:
      ...
      - name: Laravel Deployment Action
        ...
        # uses: Pentangle/laravel-deployment-action@9ec9fe0ecd61544b494e8f23ba8886533050000b
        uses: Pentangle/laravel-deployment-action@v1.0.4
        with:
          # SSH key for deploying, Should be added as a **secret**
          DEPLOY_KEY: ${{ secrets.DEPLOYKEY }} # default is ${{ secrets.DEPLOYKEY }}
          # IP address of the server being deployed to, Should be added as a **secret**
          SERVER_IP: ${{ secrets.SERVERIP }} # default is ${{ secrets.SERVERIP }}
          ...
          SSH_USER: ${{ secrets.SSHUSER }} # default is ${{ secrets.SSHUSER }}
